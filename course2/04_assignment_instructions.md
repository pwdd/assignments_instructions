...
page, login with a correct password, and proceed to the root URI. Nothing will stop an un-authenticated user
...
there is a user associated with the session.
...
the current session state. With this snippet in place – you should be able to login and see the cur-
rent_user.username displayed in the right, top corner of the display.
